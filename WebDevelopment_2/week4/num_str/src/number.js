...
export function NumberListA(start, end) {
...
export function NumberListB(start, count, skipEvery) {
...
export function NumberListC(start, count, shouldBeRandomOrNot) {
...
export function IsOdd(aNumber) {
  // is a number odd? true false
  return aNumber % 2 !== 0;
}

export function IsEven(aNumber) {
  // is a number even? true false
  return aNumber % 2 === 0;
}

export function RandomNumberList(start, end, count) {
  // return list of random numbers between start and end
  return RandomNumberListDup(start, end, count, true);
}

export function RandomNumberListDup(start, end, count, allowDuplicates) {
